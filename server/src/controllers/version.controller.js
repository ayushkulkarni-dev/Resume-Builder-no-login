...
export const saveVersion = async (req, res, next) => {
  try {
    ...
    const version = await versionService.saveVersion(req.params.resumeId, label);
...
export const getVersions = async (req, res, next) => {
  try {
    const versions = await versionService.getVersions(req.params.resumeId);
...
export const deleteVersion = async (req, res, next) => {
  try {
    await versionService.deleteVersion(req.params.resumeId, req.params.versionId);
