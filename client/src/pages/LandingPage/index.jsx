    ...
    <div>
      ...
      <section className="landing-hero">
        <div className="landing-hero-content">
          ...
          <div className="flex-row gap-md" style={{ marginTop: '28px' }}>
            <Link to="/home" className="btn btn-primary-gradient">
      ...
      <section className="landing-cta">
        ...
        <div style={{ marginTop: '32px' }}>
          <Link to="/home" className="btn btn-primary-gradient" style={{ background: '#ffffff', color: '#7c3aed', padding: '14px 36px', fontSize: '16px' }}>
            Get Started <HiArrowRight />
          </Link>
        </div>
